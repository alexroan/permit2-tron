    ...
    TokenProvider
{
    ...
    function testDeployPermit2() public {
        ...
        // Since we've modified Permit2 for TIP-712, the bytecode won't match the precompiled version
        // Just ensure both contracts were deployed successfully
        assertTrue(address(permit2).code.length > 0);
        assertTrue(address(realPermit2).code.length > 0);
    }
