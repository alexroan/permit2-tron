module.exports = {
  ...
  networks: {
    mainnet: {
      ...
      /**
       * Create a .env file in the project root (it must be gitignored) containing something like
       *
       *   PRIVATE_KEY_MAINNET=4E7FEC...656243
       *
    ...
    development: {
      ...
      // Using the consistent default private key when useDefaultPrivateKey=true
